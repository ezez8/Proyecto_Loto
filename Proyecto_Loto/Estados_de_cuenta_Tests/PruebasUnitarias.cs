...
namespace Estados_de_cuenta_Tests
{
    ...
    public class PruebasUnitarias
    {
        ...
        public void consultar_ganancia_usuario_apostador_valido()
        {
            ...
            Assert.IsTrue(respuesta.respuesta >= 0);
        }
        ...
        {
            respuesta = edoCuentas.consultar_ganancia_usuario_apostador_fecha(1, "1997-01-01");
            Assert.IsTrue(respuesta.respuesta >= 0);
        }
        ...
        {
            respuesta = edoCuentas.consultar_ganancia_usuario_apostador_fecha(1, "3000-01-01");
        ...
        {
            respuesta = edoCuentas.consultar_perdida_usuario_apostador_fecha(1, "1997-01-01");
            Assert.IsTrue(respuesta.respuesta >= 0);
        }
        ...
        {
            respuesta = edoCuentas.consultar_perdida_usuario_apostador_fecha(1, "3000-01-01");
            Assert.AreEqual(respuesta.mensaje, "Fecha mayor a la actual");
        }
        ...
        {
            respuesta = edoCuentas.consultar_ganancia_usuario_apostador_juego(1, 1);
            Assert.IsTrue(respuesta.respuesta >= 0);
        }
        ...
        {
            respuesta = edoCuentas.consultar_perdida_usuario_apostador_juego(1, 1);
            Assert.IsTrue(respuesta.respuesta >= 0);
        }
        ...
        {
            respuesta = edoCuentas.consultar_ganancia_usuario_apostador_fecha_juego(1, "1997-01-01", 1);
            Assert.IsTrue(respuesta.respuesta >= 0);
        }
        ...
        {
            respuesta = edoCuentas.consultar_ganancia_usuario_apostador_fecha_juego(1, "3000-01-01", 1);
            Assert.AreEqual(respuesta.mensaje, "Fecha mayor a la actual");
        }
        ...
        {
            respuesta = edoCuentas.consultar_perdida_usuario_apostador_fecha_juego(1, "1997-01-01", 1);
            Assert.IsTrue(respuesta.respuesta >= 0);
        }
        ...
        {
            respuesta = edoCuentas.consultar_perdida_usuario_apostador_fecha_juego(1, "3000-01-01", 1);
            Assert.AreEqual(respuesta.mensaje, "Fecha mayor a la actual");
        }
        ...
        {
            respuesta = edoCuentas.consultar_ganancia_usuario_normal_fecha(1, "1997-01-01");
            Assert.IsTrue(respuesta.respuesta >= 0);
        }
        ...
        {
            respuesta = edoCuentas.consultar_ganancia_usuario_normal_fecha(1, "3000-01-01");
            Assert.AreEqual(respuesta.mensaje, "Fecha mayor a la actual");
        }
        ...
        {
            respuesta = edoCuentas.consultar_perdida_usuario_normal_fecha(1, "1997-01-01");
            Assert.IsTrue(respuesta.respuesta >= 0);
        }
        ...
        {
            respuesta = edoCuentas.consultar_perdida_usuario_normal_fecha(1, "3000-01-01");
            Assert.AreEqual(respuesta.mensaje, "Fecha mayor a la actual");
        }
        ...
        {
            respuesta = edoCuentas.consultar_ganancia_usuario_normal_juego(1, 1);
            Assert.IsTrue(respuesta.respuesta >= 0);
        }
        ...
        {
            respuesta = edoCuentas.consultar_perdida_usuario_normal_juego(1, 1);
            Assert.IsTrue(respuesta.respuesta >= 0);
        }
        ...
        {
            respuesta = edoCuentas.consultar_ganancia_usuario_normal_fecha_juego(1, "1997-01-01", 1);
            Assert.IsTrue(respuesta.respuesta >= 0);
        }
        ...
        {
            respuesta = edoCuentas.consultar_ganancia_usuario_normal_fecha_juego(1, "3000-01-01", 1);
            Assert.AreEqual(respuesta.mensaje, "Fecha mayor a la actual");
        }
        ...
        {
            respuesta = edoCuentas.consultar_perdida_usuario_normal_fecha_juego(1, "1997-01-01", 1);
            Assert.IsTrue(respuesta.respuesta >= 0);
        }
        ...
        {
            respuesta = edoCuentas.consultar_perdida_usuario_normal_fecha_juego(1, "3000-01-01", 1);
            Assert.AreEqual(respuesta.mensaje, "Fecha mayor a la actual");
        }
        ...
        {
            respuesta = edoCuentas.consultar_ganancia_usuario_normal_hijos_fecha(1, "2000-10-02");
            Assert.IsTrue(respuesta.respuesta >= 0);
        }
        ...
        {
            respuesta = edoCuentas.consultar_ganancia_usuario_normal_hijos_fecha(1, "3000-10-02");
            Assert.AreEqual(respuesta.mensaje, "Fecha mayor a la actual");
        }
        ...
        {
            respuesta = edoCuentas.consultar_perdida_usuario_normal_hijos_fecha(1, "2000-10-02");
            Assert.IsTrue(respuesta.respuesta >= 0);
        }
        ...
        {
            respuesta = edoCuentas.consultar_perdida_usuario_normal_hijos_fecha(1, "3000-10-02");
            Assert.AreEqual(respuesta.mensaje, "Fecha mayor a la actual");
        }
        ...
        {
            respuesta = edoCuentas.consultar_ganancia_usuario_normal_hijos_juego(1, 1);
            Assert.IsTrue(respuesta.respuesta >= 0);
        }
        ...
        {
            respuesta = edoCuentas.consultar_perdida_usuario_normal_hijos_juego(1, 1);
            Assert.IsTrue(respuesta.respuesta >= 0);
        }
        ...
        {
            respuesta = edoCuentas.consultar_ganancia_usuario_normal_hijos_fecha_juego(1, "2000-10-02", 1);
            Assert.IsTrue(respuesta.respuesta >= 0);
        }
        ...
        {
            respuesta = edoCuentas.consultar_ganancia_usuario_normal_hijos_fecha_juego(1, "3000-10-02", 1);
            Assert.AreEqual(respuesta.mensaje, "Fecha mayor a la actual");
        }
        ...
        {
            respuesta = edoCuentas.consultar_perdida_usuario_normal_hijos_fecha_juego(1, "2000-10-02", 1);
        }
        ...
        {
            respuesta = edoCuentas.consultar_perdida_usuario_normal_hijos_fecha_juego(1, "3000-10-02", 1);
            Assert.AreEqual(respuesta.mensaje, "Fecha mayor a la actual");
        }
